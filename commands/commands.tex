...
if this is a PiP root or PiP task (first charatcer. '{\tt R}' means
root, the other numerical digit '{\tt 0-9}' means PiP task. The second
character represents PiP execution mode, explaind in
Section~\ref{sec:exec-mode}).

This \pipterm{pips} command has many options. Refer PiP man page for
...
The \pipterm{pip-mode} command is to set PiP executoin mode (refer to
Section~\ref{sec:exec-mode}). 
