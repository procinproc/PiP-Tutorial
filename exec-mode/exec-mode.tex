...
The meaning of \pipterm{pip_is_threaded()} and
\pipterm{pip_is_shared_fd()} are the same in the current
...
\pipterm{PIP_MODE_PROCESS} and \pipterm{PIP_MODE_PTHREAD}, {\tt or}ing
...
both, then the value of \pipterm{PIP_MODE} environment variable is
