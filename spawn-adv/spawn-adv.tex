...
\pipterm{PIP_STACKSIZE} environment variable. Like the {\tt
...
{\it KiB} is assumed. Unless \pipterm{PIP_STACKSIZE} is
...
OpenMP threads, however, \pipterm{PIP_STACKSIZE} only affects the stack
size of PiP tasks. 
...
\pipterm{PIP_CPUCORE_ABS} flag. If the core numbers are consecutive,
...
The {\tt coreno} argument can be \pipterm{PIP_CPUCORE_ASIS} to bind to
